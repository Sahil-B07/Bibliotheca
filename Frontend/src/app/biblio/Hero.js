...
const Hero = ({myFont}) => {
  ...
  return (
    <section className="relative flex h-screen bg-black -z-10" id="hero">
      ...
      <div className="relative grid w-full p-6 md:grid md:grid-cols-6 md:p-0">
        <div className="mr-auto mt-10 place-self-center md:col-span-2 md:col-start-2 md:flex md:flex-col">
          ...
          >
            <Link href={"/biblio/library"}>
              <span className="text-xl text-black !font-bold cursor-pointer z-30">
                Get Started &nbsp;
              </span>
